...
class Book_deatils extends StatefulWidget {
  final String docid;
  const Book_deatils({super.key, required this.docid});

  @override
  State<Book_deatils> createState() => _Book_deatilsState();
}

class _Book_deatilsState extends State<Book_deatils> {
                ...
                TextButton(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text("Successfully taken"),
                        ),
                      );
...
// }
        ...
        label: const Text("Check avaiblity"),
      ),
    );
  }
